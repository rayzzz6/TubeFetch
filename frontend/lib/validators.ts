...
/**
 * Client-side YouTube URL validation, mirroring the backend's rules.
 * This is a UX convenience (instant feedback) — the backend always
 * re-validates, since client checks can never be trusted.
 */
